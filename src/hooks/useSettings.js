...
import { getSettings, saveSettings, DEFAULT_SETTINGS, applyTheme, applyLanguage } from '@/services/settingsApi';
...
export function useSettings() {
  ...
  const reset = useCallback(() => {
    ...
    localStorage.setItem('smartchef_settings', JSON.stringify(DEFAULT_SETTINGS));
  }, []);
