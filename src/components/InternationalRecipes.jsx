...
const getFlag = (countryName) => {
  const flags = {
    ...
    'Marrocos': '🇲🇦', 'Vietname': '🇻🇳', 'Ucrânia': '🇺🇦', 'Argélia': '🇩🇿', 'Suécia': '🇸🇪', 
    'Angola': '🇦🇴', 'Etiópia': '🇪🇹', 'Egito': '🇪🇬', 'Senegal': '🇸🇳', 'Mali': '🇲🇱', 'Quénia': '🇰🇪',
    'Camarões': '🇨🇲', 'Gâmbia': '🇬🇲', 'Zimbabwe': '🇿🇼', 'Lesoto': '🇱🇸', 'Moçambique': '🇲🇿',
    'Madagáscar': '🇲🇬', 'Israel': '🇮🇱', 'Jordânia': '🇯🇴', 'Arábia Saudita': '🇸🇦', 'Líbano': '🇱🇧',
    'Irão': '🇮🇷', 'Paquistão': '🇵🇰', 'Nepal': '🇳🇵', 'Geórgia': '🇬🇪', 'Rússia': '🇷🇺', 
    'Polónia': '🇵🇱', 'República Checa': '🇨🇿', 'Dinamarca': '🇩🇰', 'Noruega': '🇳🇴',
    ...
    'Venezuela': '🇻🇪', 'Irlanda': '🇮🇪', 'Suíça': '🇨🇭', 'Bósnia': '🇧🇦', 'Sérvia': '🇷🇸', 
    'Turquia': '🇹🇷', 'Cabo Verde': '🇨🇻', 'República do Congo': '🇨🇬', 'Alemanha': '🇩🇪',
    'Austrália': '🇦🇺', 'Nova Zelândia': '🇳🇿', 'Afeganistão': '🇦🇫', 'Albânia': '🇦🇱',
    'Andorra': '🇦🇩', 'Antígua e Barbuda': '🇦🇬', 'Azerbaijão': '🇦🇿', 'Bahamas': '🇧🇸',
    'Bahrein': '🇧🇭', 'Bangladesh': '🇧🇩', 'Barbados': '🇧🇧', 'Bielorrússia': '🇧🇾',
    'Belize': '🇧🇿', 'Benim': '🇧🇯', 'Butão': '🇧🇹', 'Botsuana': '🇧🇼', 'Brunei': '🇧🇳',
    'Bulgária': '🇧🇬', 'Burquina Faso': '🇧🇫', 'Burundi': '🇧🇮', 'Camboja': '🇰🇭',
    'Chade': '🇹🇩', 'Comores': '🇰🇲', 'Costa do Marfim': '🇨🇮', 'Costa Rica': '🇨🇷',
    'Croácia': '🇭🇷', 'Chipre': '🇨🇾', 'Djibuti': '🇩🇯', 'Dominica': '🇩🇲', 
    'República Dominicana': '🇩🇴', 'El Salvador': '🇸🇻', 'Guiné Equatorial': '🇬🇶',
    'Eritreia': '🇪🇷', 'Estónia': '🇪🇪', 'Fiji': '🇫🇯', 'Gabão': '🇬🇦', 'Gana': '🇬🇭',
    'Granada': '🇬🇩', 'Guatemala': '🇬🇹', 'Guiné': '🇬🇳', 'Guiné-Bissau': '🇬🇼',
    'Guiana': '🇬🇾', 'Honduras': '🇭🇳', 'Islândia': '🇮🇸', 'Iraque': '🇮🇶', 'Jamaica': '🇯🇲',
    'Quirguistão': '🇰🇬', 'Kiribati': '🇰🇮', 'Kuwait': '🇰🇼', 'Laos': '🇱🇦', 'Letónia': '🇱🇻',
    'Libéria': '🇱🇷', 'Líbia': '🇱🇾', 'Liechtenstein': '🇱🇮', 'Lituânia': '🇱🇹',
    'Luxemburgo': '🇱🇺', 'Madagascar': '🇲🇬', 'Malaui': '🇲🇼', 'Maldivas': '🇲🇻',
    'Malta': '🇲🇹', 'Ilhas Marshall': '🇲🇭', 'Mauritânia': '🇲🇷', 'Maurícia': '🇲🇺',
    'Micronésia': '🇫🇲', 'Moldávia': '🇲🇩', 'Mónaco': '🇲🇨', 'Mongólia': '🇲🇳',
    'Montenegro': '🇲🇪', 'Mianmar': '🇲🇲', 'Namíbia': '🇳🇦', 'Nauru': '🇳🇷',
    'Nicarágua': '🇳🇮', 'Níger': '🇳🇪', 'Macedónia do Norte': '🇲🇰', 'Omã': '🇴🇲',
    'Palau': '🇵🇼', 'Panamá': '🇵🇦', 'Papua Nova Guiné': '🇵🇬', 'Paraguai': '🇵🇾',
    'Catar': '🇶🇦', 'Roménia': '🇷🇴', 'Ruanda': '🇷🇼', 'São Cristóvão e Neves': '🇰🇳',
    'Santa Lúcia': '🇱🇨', 'São Vicente e Granadinas': '🇻🇨', 'Samoa': '🇼🇸',
    'San Marino': '🇸🇲', 'São Tomé e Príncipe': '🇸🇹', 'Seicheles': '🇸🇨',
    'Serra Leoa': '🇸🇱', 'Eslováquia': '🇸🇰', 'Eslovénia': '🇸🇮', 'Ilhas Salomão': '🇸🇧',
    'Somália': '🇸🇴', 'Sudão do Sul': '🇸🇸', 'Sri Lanka': '🇱🇰', 'Sudão': '🇸🇩',
    'Suriname': '🇸🇷', 'Síria': '🇸🇾', 'Tajiquistão': '🇹🇯', 'Tanzânia': '🇹🇿',
    'Timor-Leste': '🇹🇱', 'Togo': '🇹🇬', 'Tonga': '🇹🇴', 'Tunísia': '🇹🇳',
    'Turquemenistão': '🇹🇲', 'Tuvalu': '🇹🇻', 'Uganda': '🇺🇬', 'Emirados Árabes Unidos': '🇦🇪',
    'Vanuatu': '🇻🇺', 'Vaticano': '🇻🇦', 'Iémen': '🇾🇪', 'Zâmbia': '🇿🇲',
  
    'Escócia': 'EC', 'País de Gales': '🏴󠁧󠁢󠁷󠁬󠁳󠁿', 'Inglaterra': 'IN', 'Palestina': '🇵🇸'
  };
