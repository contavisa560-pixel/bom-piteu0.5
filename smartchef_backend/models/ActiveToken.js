...
// 🔥 REMOVA O MIDDLEWARE PROBLEMÁTICO e simplifique:

// Método para verificar se está expirado (sem middleware)
...
activeTokenSchema.statics.cleanExpiredTokens = async function () {
  try {
    ...
    console.log(`🗑️ Limpados ${result.deletedCount} tokens expirados`);
    return result;
  } catch (error) {
